...
public class RegistrarColeccion extends JFrame {
	...
	public RegistrarColeccion(ConexionObjetosMenus dato) {
		setTitle("Registro de Obra perteneciente a una coleccion");
		datos = dato;
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 394, 596);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!(textField.getText().trim().isEmpty()) && !(textField_1.getText().trim().isEmpty()) && !(textField_2.getText().trim().isEmpty()) && !(textField_3.getText().trim().isEmpty()) && !(textField_4.getText().trim().isEmpty()) &&  !(textField_7.getText().trim().isEmpty()) &&  !(textField_10.getText().trim().isEmpty()) && !(textArea.getText().trim().isEmpty() && !(textField_8.getText().trim().isEmpty()) && !(textField_9.getText().trim().isEmpty())) 
						&& validarTex(textField.getText().trim()) && validarTex(textField_4.getText().trim()) && validarTex(textField_5.getText().trim()) && validarTex(textField_6.getText().trim()) && validarTex(textField_8.getText().trim())) {
				if(!(datos.ComprobarObra(textField_10.getText().trim()))) {
                   try { 
                	   datos.CrearColeccion(textField.getText().trim(), textField_1.getText().trim(), textField_2.getText().trim(), textField_3.getText().trim(), textField_4.getText().trim(), textField_5.getText().trim(), textField_6.getText().trim(), textField_7.getText().trim(),  textField_10.getText().trim(), textArea.getText(), textField_8.getText().trim(), textField_9.getText().trim());
		...
		btnNewButton.setBounds(206, 521, 89, 23);
		...
		btnAtras.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        MP.setVisible(true);
		        RegistrarColeccion.this.setVisible(false);
			}
		});
		btnAtras.setBounds(79, 521, 89, 23);
		contentPane.add(btnAtras);
		
		textField_8 = new JTextField();
		textField_8.setColumns(10);
		textField_8.setBounds(156, 431, 140, 25);
		contentPane.add(textField_8);
		
		textField_9 = new JTextField();
		textField_9.setColumns(10);
		textField_9.setBounds(156, 469, 140, 25);
		contentPane.add(textField_9);
		
		JLabel lblNewLabel_6 = new JLabel("Nombre de la coleccion:");
		lblNewLabel_6.setBounds(12, 435, 136, 16);
		contentPane.add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("ISBN de la coleccion:");
		lblNewLabel_7.setBounds(32, 473, 118, 16);
