...
public class ObrasMasSolicitadasPorPublGen extends JFrame {
	...
	public ObrasMasSolicitadasPorPublGen(ConexionObjetosMenus dato) {
		setTitle("Obras mas solicitadas por publico general");
		datos = dato;
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		        ...
		        MP.setVisible(true);
		        ObrasMasSolicitadasPorPublGen.this.setVisible(false);
			}
		});
		btnNewButton_2.setBounds(322, 406, 89, 23);
